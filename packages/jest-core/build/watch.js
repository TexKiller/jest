...
async function watch(
  ...
  const startRun = (globalConfig, validPaths) => {
    var _getChangedFilesPromi;
    ...
    const changedFilesPromise =
      (_getChangedFilesPromi = (0, _getChangedFilesPromise.default)(
        globalConfig,
        configs
      )) === null || _getChangedFilesPromi === void 0
        ? void 0
        : _getChangedFilesPromi.then(changedFiles =>
            validPaths
              ? {
                  ...changedFiles,
